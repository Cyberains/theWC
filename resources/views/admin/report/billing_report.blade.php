...
@section('title')
    ...
    <title>Billing Report | Report Management</title>
...
@section('btitle1')
    ...
    <li class="breadcrumb-item">Billing Report</li>
...
@section('body')
  ...
  <div class="container-fluid">
    <div class="fade-in">                  
          <form class="sform" action ="{{ route('admin.billing_report_generate') }}"  method="post" autocomplete="off">
            @csrf
            <div class="row bg-white mx-0 py-3 mt-2">
              <div class="col-md-4 pb-3">
                <label>Billing Report Type<span>*</span></label>
