            ...
            <div class="col-md-12 px-0">
                <table class="table table-hover tablescroll ">
                  ...
                  <tbody class="wrapper">
                    ...
                    $basic_price=json_decode($purchasedata->unitprice);
                   ...
                   // $unit_tax_percentage=json_decode($purchasedata->unit_tax_percentage);
                    ...
                    <tr class="items">
                     ...
                     <td>
                      ...
                      <td>
                          <input type="text" name="tax[]" class="form-control" value="@if($tax_price[$key]){{$tax_price[$key]}}@endif" readonly="" id="tax_{{$key}}">
                      </td>
                      <td>
...
//sku click 
 ...
 var token = $('meta[name="csrf-token"]').attr('content');
      ...
      $.ajax({
          ...
          console.log(data.productdata);
           ...
           purchaseprice='<option>Select Here</option>';
              ...
              $('#purchaseprices_'+rowid+'').html(purchaseprice);
            }
           else if(data.status == 0){
                $('#sku option').remove();
                html = "<option value='No Record Found'/>";
  ...
  $(document).on('change','.buy',function(){
   ...
   purchage=$('#purchaseprices_'+idcount+'').val();
  
    $('#purchase_'+idcount+'').val(purchage);
 ...
 // console.log(title);
       $.ajax({
          ...
          // console.log(data.tax);
           $('#tax_'+idcount+'').val(data.productdata);
tax=data.productdata;
$('#amount_'+idcount+'').val(purchage);
recqty=$('#receiveqty_'+idcount+'').val();
