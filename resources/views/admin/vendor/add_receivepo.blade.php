        ...
        <div class="row mx-0 py-3 mt-2 bg-white mb-4">
          ...
          <div class="col-sm-3">
           <div class="form-group">
              ...
              <input type="number" placeholder="Enter Invoice Number" class="form-control" id="  invoicenumber" name="invoicenumber" value="{{old('  invoicenumber')}}" min="0" data-parsley-required data-parsley-required-message="Enter Invoice Number">
            </div>
         </div>
          <div class="col-sm-3">
           <div class="form-group">
              <label for="invoicevalue">Invoice Value <span>*</span></label>
              <input type="number" step="0.01" class="form-control" id="invoicevalue" aria-describedby="invoice value " name="invoicevalue" placeholder="Enter Invoice Value" value="{{old('invoicevalue')}}" min="0" data-parsley-required data-parsley-required-message="Enter Invoice Value">
            </div>
          </div>
          <div class="col-sm-3">
            <div class="form-group">
          ...
          <div class="col-sm-3">
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="carrier" name="carriername" placeholder="Enter Carrier Name" value="{{old('carriername')}}" data-parsley-required data-parsley-required-message = "Enter Carrier Name">
            </div>
          </div>
          <div class="col-sm-3">
            <div class="form-group">
                    ...
                    <tr>
                     ...
                     {{--<th>Discount</th>--}}
                      ...
                      <th>Return Quantity<br>
                        <span style="font-size: 11px;">Damage/Expiry</span></th>
                  ...
                  <tbody class="wrapper">
                    ...
                    <tr class="items">
                     ...
                     <td>
                      ...
                      <td><input type="textbox" name="barcode_id[]" id="barcode_{{$key}}" value="@if($barcode){{  $barcode->barcode_id }}@endif" class="form-control" required></td>
                      ...
                      <td style="display: ;">
                          <input type="hidden" name="hiddenttax[]" id="hiddenttax_{{$key}}" class="hiddenttax" value="{{$tax_price[$key]}}">
                      </td>
...
@section('script')
  ...
  <script type="text/javascript">
    $(document).ready(function(){
        ...
        var url1 = "{{ route('admin.addreceivepo',['id'=>$purchasedata->id]) }}";
        var url2 = window.location.href;

        if (url1==url2) {

            $('a[href="'+'{{ route('admin.addreceivepo') }}' + '"]').addClass('c-active');

            $('a[href="' + '{{ route('admin.addreceivepo') }}' + '"]').parent().parent().parent().addClass('c-show');
