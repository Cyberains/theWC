...
@section('body')
  ...
  <div class="container-fluid">
    <div class="fade-in">
      ...
      <form class="sform" id="grn_without_form" action="{{ route('admin.add_grn_without_po') }}" method="post">
      @csrf  
        ...
        <div class="row bg-white mx-0 py-3 mt-2" id="add_grn_info">
            ...
            <div class="col-md-3">
              <div class="form-group barcode_div">
                <label for="barcode_id">Barcode ID:<span>*</span></label>
          ...
          <div class="col-md-12 text-right mt-2">
            <button type="button" name="grn_without_submit" id="grn_without_submit" class="btn btn-primary">Save GRN</button>
          </div>                    
        </div>
