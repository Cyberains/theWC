...
@section('title')
    <title>City Import | City Management</title>
@endsection
@section('btitle')
...
@endsection
@section('btitle2')
    <li class="breadcrumb-item">Import City</li>
@endsection
@section('style')
  <style type="text/css">
    .preview-image img{
    ...
    <div class="fade-in">
        <div class="row bg-white mx-0 py-3 mt-2 mb-4">
          <div class="col-md-12">
            <div class="row border-bottom">
              <div class="col-md-12 col-xl-12">
                <a href="{{ route('admin.download_csv_sample-city')}}" class="btn btn-primary "><i class="fa fa-download"></i> Download Sample</a><br><br>
              </div>
            </div>
          ...
          <div class="row mx-0 bg-white mt-2 pb-3">
            <div class="col-md-12">
               <form action="{{ route('admin.import_csv-city') }}" method="post" class="form-horizontal" enctype="multipart/form-data">
                  @csrf
                  <div class="form-group my-3">
                    ...
                    <div class="col-md-12 py-3">
                      ...
                      <a href="{{ route('admin.cities') }}" class="btn btn-info float-right mr-3 ">cancel</a>
                    </div>
                  </div>
              </form>
            </div>
...
@section('script')
  <script type="text/javascript">
      var url1 = "{{ route('admin.import-city') }}";
      var url2 = window.location.href;
      if (url1 === url2) {
        $('a[href="'+'{{ route('admin.cities') }}' + '"]').addClass('c-active');

        $('a[href="' + '{{ route('admin.cities') }}' + '"]').parent().parent().parent().addClass('c-show');
      };
  </script>
@endsection
