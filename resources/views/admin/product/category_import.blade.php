...
@section('title')
    ...
    <title>Category Import | Product Management</title>
...
@section('btitle2')
    ...
    <li class="breadcrumb-item">Import Category</li>
    ...
    <div class="fade-in">
        <div class="row bg-white mx-0 py-3 mt-2 mb-4">
          <div class="col-md-12">
            <div class="row border-bottom">
              <div class="col-md-12 col-xl-12">
                <a href="{{ route('admin.download_csv_sample_category')}}" class="btn btn-primary "><i class="fa fa-download"></i> Download Sample</a><br><br>
              </div>
            </div>
          ...
          <div class="row mx-0 bg-white mt-2 pb-3">
            <div class="col-md-12">
               <form action="{{ route('admin.import_csv_category') }}" method="post" class="form-horizontal" enctype="multipart/form-data">
                  @csrf
                  <div class="form-group my-3">
                    ...
                    <div class="col-md-12 py-3">
                      ...
                      <a href="{{ route('admin.category') }}" class="btn btn-info float-right mr-3 ">cancel</a>
...
@section('script')
  ...
  <script type="text/javascript">
      ...
      var url1 = "{{ route('admin.import_category') }}";
      var url2 = window.location.href;

      if (url1==url2) {

        $('a[href="'+'{{ route('admin.category') }}' + '"]').addClass('c-active');

        $('a[href="' + '{{ route('admin.category') }}' + '"]').parent().parent().parent().addClass('c-show');
