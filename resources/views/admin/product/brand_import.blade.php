...
@section('title')
    ...
    <title>Brand Import | Product Management</title>
...
@section('btitle2')
    ...
    <li class="breadcrumb-item">Import brand</li>
    ...
    <div class="fade-in">
        <div class="row bg-white mx-0 py-3 mt-2 mb-4">
          <div class="col-md-12">
            <div class="row border-bottom">
              <div class="col-md-12 col-xl-12">
                <a href="{{ route('admin.download_csv_sample_brand')}}" class="btn btn-primary "><i class="fa fa-download"></i> Download Sample</a><br><br>
              </div>
            </div>
                  ...
                  <table class="table table-striped table-bordered" cellspacing="0"  width="500px" style="overflow:auto;">
                    <thead>
                      ...
                      <tbody>
                          <tr>
                             <td>Nestle</td>
                             <td>Nestle is the largest food company in the world, in terms of revenue.</td>
          ...
          <div class="row mx-0 bg-white mt-2 pb-3">
            <div class="col-md-12">
               <form action="{{ route('admin.import_csv_brand') }}" method="post" class="form-horizontal" enctype="multipart/form-data">
                  @csrf
                  <div class="form-group my-3">
                    ...
                    <div class="col-md-12 py-3">
                      ...
                      <a href="{{ route('admin.brand') }}" class="btn btn-info float-right mr-3 ">cancel</a>
