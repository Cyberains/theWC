...
@if($billingdata->payment_method=='COD' && $billingdata->payment_method1==null && $billingdata->eb_coupon_method==null)

<div style="padding-top:5px;padding-bottom:5px;border-bottom: 1px dotted black;font-size: 11px;">
...
@elseif($billingdata->payment_method=='COD' && $billingdata->eb_coupon_method!=null && $billingdata->payment_method1==null)
...
<div style="padding-top:5px;padding-bottom:5px;border-bottom: 1px dotted black;font-size: 11px;">
    ...
    <div style="float: left;">
        <p style="margin:0px;padding:0px"><strong>Payment mode : </strong>{{ $billingdata->eb_coupon_method }}</p>
    </div>
    <div style="float: right;">

        <p style="margin:0px;padding:0px"><strong>Paid Amount : </strong>{{ number_format($billingdata->eb_coupon_cash,2) }}/-</p>
      
    </div>
    <div style="clear: both;"></div>
    {{-- <div>
        <p style="margin:0px;padding:0px;text-align: right"><strong>Return Amount : </strong>{{ number_format($billingdata->eb_coupon_cash+$billingdata->received_cash-$billingdata->grand_total,2) }}/-</p>
    </div> --}}
...
<div style="padding-top:5px;padding-bottom:5px;border-bottom: 1px dotted black;font-size: 11px;">
    ...
    <div style="float: right;">
        ...
        <p style="margin:0px;padding:0px"><strong>Paid Amount : </strong>{{ number_format($billingdata->received_cash1,2) }}/-</p>
...
@elseif($billingdata->payment_method=='COD' && $billingdata->payment_method1!=null && $billingdata->eb_coupon_method==null)
